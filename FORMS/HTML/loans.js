document.addEventListener('DOMContentLoaded', function() {
    // Function to create mobile navbar
    ...
    const closeSidebarOnClickOutside = (event) => {
        ...
        const isClickOnMenuToggle = menuToggle.contains(event.target) || document.querySelector('.menu-toggle-btn').contains(event.target);
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    mobileNavbar.innerHTML = `
        <div class="mobile-nav-items">
            <a href="desboard.html" class="mobile-nav-item active">
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    requestCards.forEach((card) => {
      ...
      rejectBtn.addEventListener("click", () => {
        ...
        // Show rejected message with animation
        const msg = document.createElement("p");
        msg.textContent = "❌ Rejected";
        msg.classList.add("rejected-msg");
        card.querySelector(".request-actions").appendChild(msg);
      });
  
      acceptBtn.addEventListener("click", () => {
        // Redirect to another page
        window.location.href = "accepted-order.html"; // or whatever your page is
      });
    });
  });
